...
//remain
        if((c_elf_rating > 3.98) & (toy_row(1) < myToys_1.nrow())){
            ...
            if((sanc_rate <= 0.8) || (late_start >= 10000)){
...
//ex1            
        }else if((c_elf_rating > 3.6) && (toy_row(3) < myToys_3.nrow()) && (toy_row(0) >= myToys_0.nrow())){
            
            int c_elf_start_time_2 = std::max(c_elf_start_time, (int)myToys_3(toy_row(3),1)); //toy1 start time 
            
            late_start = (c_elf_start_time_2 - (int)myelves(min_row,2));
            
            if((late_start >= 10000)&&(toy_row(0) < myToys_0.nrow())){
...
//re3            
        }else if((c_elf_rating >= .38) & (toy_row(6) < myToys_6.nrow())){
...
//re2            
        }else if((c_elf_rating >= .32) & (toy_row(5) < myToys_5.nrow())){
