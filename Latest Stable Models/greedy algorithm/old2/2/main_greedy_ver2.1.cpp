...
//tr7            
        }else if((c_elf_rating <= 3.9) & (c_elf_rating >= 3.28) & (toy_row(17) < myToys_17.nrow())){
...
//tr6            
        }else if((c_elf_rating < 3.28) & (c_elf_rating >= 2.69) & (toy_row(16) < myToys_16.nrow())){
...
//tr5            
        }else if((c_elf_rating < 2.69) & (c_elf_rating >= 2.21) & (toy_row(15) < myToys_15.nrow())){
...
//tr4            
        }else if((c_elf_rating < 2.21) & (c_elf_rating >= 1.81) & (toy_row(14) < myToys_14.nrow())){
...
//tr3            
        }else if((c_elf_rating < 1.81) & (c_elf_rating >= 1.49) & (toy_row(13) < myToys_13.nrow())){
...
//tr2            
        }else if((c_elf_rating < 1.49) & (c_elf_rating >= 1.22) & (toy_row(12) < myToys_12.nrow())){
...
//tr1            
        }else if((c_elf_rating < 1.22) & (c_elf_rating >= 1.0) & (toy_row(11) < myToys_11.nrow())){
...
//re7            
        }else if((c_elf_rating < 1) & (c_elf_rating >= .82) & (toy_row(10) < myToys_10.nrow())){
...
//re6            
        }else if((c_elf_rating < .82) & (c_elf_rating >= .67) & (toy_row(9) < myToys_9.nrow())){
...
//re5            
        }else if((c_elf_rating < .67) & (c_elf_rating >= .55) & (toy_row(8) < myToys_8.nrow())){
...
//re4            
        }else if((c_elf_rating < .55) & (c_elf_rating >= .45) & (toy_row(7) < myToys_7.nrow())){
...
//re3            
        }else if((c_elf_rating < .45) & (c_elf_rating >= .37) & (toy_row(6) < myToys_6.nrow())){
...
//re2            
        }else if((c_elf_rating < .37) & (c_elf_rating >= .3) & (toy_row(5) < myToys_5.nrow())){
...
//re1            
        }else if((c_elf_rating < .3) & (c_elf_rating >= .25) & (toy_row(4) < myToys_4.nrow())){
