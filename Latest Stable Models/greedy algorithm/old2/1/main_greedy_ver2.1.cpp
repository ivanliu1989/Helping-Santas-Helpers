...
NumericMatrix solution_Elf(NumericMatrix myToys_0, NumericMatrix myToys_1,NumericMatrix myToys_2,NumericMatrix myToys_3,NumericMatrix myToys_4,NumericMatrix myToys_5,
                           ...
                           NumericVector toys_0_class, NumericVector toys_0_row){
...
//remain
        if((c_elf_rating > 3.95) & (toy_row(1) < myToys_1.nrow())){
            ...
            if(sanc_rate <= 0.8){
                ...
                int c_elf_start_time_3 = c_elf_start_time_2; //trival start time 
                int sanc_2 = getSanctionedBreakdown(c_elf_start_time_3, 600); //trival sanctional time
                
                
                if((sanc_2 <= 90)&(toys_0_row(0)<=toys_0_class(0))){
                    c_toy_id = myToys_0(toys_0_row(0),0);
                    c_toy_arrival = myToys_0(toys_0_row(0),1);
                    c_toy_duration = myToys_0(toys_0_row(0),2);
                    toys_0_row(0) += 1; 
                }else if((sanc_2 <= 180)&(toys_0_row(1)<=toys_0_class(1))){
                    c_toy_id = myToys_0(toys_0_row(1),0);
                    c_toy_arrival = myToys_0(toys_0_row(1),1);
                    c_toy_duration = myToys_0(toys_0_row(1),2);
                    toys_0_row(1) += 1; 
                }else if((sanc_2 <= 270)&(toys_0_row(2)<=toys_0_class(2))){
                    c_toy_id = myToys_0(toys_0_row(2),0);
                    c_toy_arrival = myToys_0(toys_0_row(2),1);
                    c_toy_duration = myToys_0(toys_0_row(2),2);
                    toys_0_row(2) += 1;     
                }else if((sanc_2 <= 360)&(toys_0_row(3)<=toys_0_class(3))){
                    c_toy_id = myToys_0(toys_0_row(3),0);
                    c_toy_arrival = myToys_0(toys_0_row(3),1);
                    c_toy_duration = myToys_0(toys_0_row(3),2);
                    toys_0_row(3) += 1;     
                }else if((sanc_2 <= 540)&(toys_0_row(0)<=toys_0_class(0))){
                    c_toy_id = myToys_0(toys_0_row(0),0);
                    c_toy_arrival = myToys_0(toys_0_row(0),1);
                    c_toy_duration = myToys_0(toys_0_row(0),2);
                    toys_0_row(0) += 1;     
...
//re1            
            ...
            if((toys_0_row(0)+toys_0_row(1)+toys_0_row(2)+toys_0_row(3)) < myToys_0.nrow()){
                
                int c_elf_start_time_3 = c_elf_start_time; //trival start time 
                int sanc_2 = getSanctionedBreakdown(c_elf_start_time_3, 600); //trival sanctional time
                ...
                if((sanc_2 <= 90)&(toys_0_row(0)<=toys_0_class(0))){
                    ...
                    if((toys_0_row(0)<=toys_0_class(0))){
                        c_toy_id = myToys_0(toys_0_row(0),0);
                        c_toy_arrival = myToys_0(toys_0_row(0),1);
                        c_toy_duration = myToys_0(toys_0_row(0),2);
                        toys_0_row(0) += 1; 
                    }else if((toys_0_row(1)<=toys_0_class(1))){
                        c_toy_id = myToys_0(toys_0_row(1),0);
                        c_toy_arrival = myToys_0(toys_0_row(1),1);
                        c_toy_duration = myToys_0(toys_0_row(1),2);
                        toys_0_row(1) += 1; 
                    }else if((toys_0_row(2)<=toys_0_class(2))){
                        c_toy_id = myToys_0(toys_0_row(2),0);
                        c_toy_arrival = myToys_0(toys_0_row(2),1);
                        c_toy_duration = myToys_0(toys_0_row(2),2);
                        toys_0_row(2) += 1;     
                    }else if((toys_0_row(3)<=toys_0_class(3))){
                        c_toy_id = myToys_0(toys_0_row(3),0);
                        c_toy_arrival = myToys_0(toys_0_row(3),1);
                        c_toy_duration = myToys_0(toys_0_row(3),2);
                        toys_0_row(3) += 1;     
        ...
        if(current_toy % 100000 == 0) {
            ...
            << '\n' << myToys_0.nrow() << ' ' << (toys_0_row(0)+toys_0_row(1)+toys_0_row(2)+toys_0_row(3)-toys_0_class(0)-toys_0_class(1)-toys_0_class(2))/myToys_0.nrow()*100
