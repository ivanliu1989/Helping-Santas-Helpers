...
toy_retrain1 <- c(121:173); toy_retrain2 <- c(174:210); toy_retrain3 <- c(211:256);
...
toys_0 <- toys_0[order(toys_0[,'Duration'],toys_0[,'Arrival_time']),]
...
a <- table(toys_0[,3])
sum(a[1:30]); sum(a[31:60]);sum(a[61:90]);sum(a[91:120])
nrow(toys_0) == sum(a[1:30]) + sum(a[31:60]) + sum(a[61:90]) + sum(a[91:120])
# 3255563 | 1481287 | 818043 | 514606
