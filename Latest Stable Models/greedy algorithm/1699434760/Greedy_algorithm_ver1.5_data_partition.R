...
toy_retrain1 <- c(100:150); toy_retrain2 <- c(151:183); toy_retrain3 <- c(184:223);
...
toy_train4 <- c(902:1097); toy_train5 <- c(1098:1335); toy_train6 <- c(1336:1625); toy_train7 <- c(1626:1988);
