...
toy_ex1 <- c(2849:3080,8058:8160); toy_ex2 <- 15480;

toy_remain <- 2848 # 2848

toy_retrain1 <- c(130:153); toy_retrain2 <- c(174:210); toy_retrain3 <- c(211:256);
toy_retrain4 <- c(257:312); toy_retrain5 <- c(313:381); toy_retrain6 <- c(382:464); 
toy_retrain7 <- c(465:566);
...
toy_train7 <- c(1858:2264,100:110);
...
toys[which(toys[,'Duration']%in%toy_ex1),'Size'] <- 18 # 10+14+10
...
toys_18 <- toys_18[order(toys_18[,'Arrival_time'],-toys_18[,'Duration']),]
